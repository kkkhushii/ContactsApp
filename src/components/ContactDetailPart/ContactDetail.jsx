...
function ContactDetail() {
  const {selectedContact,contacts,setContacts,starredContacts} = useDepartment();
 ...
 <div>
      {selectedContact && (
        ...
        <div>
             <img src={selectedContact.profile} alt="user" className="rounded-circle" width="46"/>
        </div>
          <div className="mx-2">
                 <h5 className="mb-0">{selectedContact.firstName} {selectedContact.lastName}</h5>
               ...
               <tbody>
                ...
                <tr><td><h6>Address</h6></td>
                 ...
                 <tr>
                     ...
                     <td>
                     <button type="button" className="btn btn-primary" onClick={() => setShowModal(true)}>Edit Contact</button>
                     <ContactDetailEditForm contacts={selectedContact} show={showModal} onHide={() => setShowModal(false)} />
                     </td>
                 </tr>
                     </tbody>
               </table>
